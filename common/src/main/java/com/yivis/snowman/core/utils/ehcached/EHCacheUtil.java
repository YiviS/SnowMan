...
public class EHCacheUtil {
     ...
     * @return List
     */
    public static List getCacheByNameList(String cacheName) {
     ...
     *
     */
    public static HashMap<String, Object> getCacheValues(String cacheName) throws Exception {
        HashMap<String, Object> retMap = new HashMap<String, Object>();
        List<String> list = getCacheByNameList(cacheName);
        for (String key : list) {
     ...
     *
     */
    public static List<Object> getCacheValuesList(String cacheName) throws Exception {
